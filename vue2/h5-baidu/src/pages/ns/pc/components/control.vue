<template>
  <div class="btn-group">
    ...
    <div class="play-btn img-btn" :style="controlStyle" @click="playBtnHandler">
      <img src="https://cdn-app..com/pe/ns/play.svg">
    </div>
    -->
    <div class="bottom-btn-group">
      <div
        class="resource-btn img-btn"
        :style="controlStyle"
        @click="resourceBtnHandler"
        v-if="tab === 'resource'"
      >
        <img src="https://cdn-app..com/pe/ns/location.svg" />
      </div>
      <!-- <div class="zoom-btn-group" :style="controlStyle">
        <div class="max-zoom-btn img-btn" @click="maxZoomHandler">
          <img src="https://cdn-app..com/PE/2021/11/11/497ea113-852a-4a20-b68f-e14e60dd1f5b.svg">
        </div>
        <div class="min-zoom-btn img-btn" @click="minZoomHandler">
          <img src="https://cdn-app..com/PE/2021/11/11/569137fe-1d17-4764-ab89-81efe6809a68.svg">
        </div>
      </div> -->
    </div>
  </div>
...
export default {
  ...
  methods: {
    playBtnHandler() {
      ...
      if (sensors) {
        sensors.track("ns_chargingmaph5_videoentry_click");
      }
    },
    resourceBtnHandler() {
