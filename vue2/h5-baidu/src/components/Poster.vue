  ...
  <div class="poster-wrapper">
    <div class="poster" ref="poster">
      <div style="padding-left: 30px; padding-right: 30px; padding-top: 30px">
        ...
        <div v-else class="distance">资源情况</div>
        <div class="card-row">
          <Card
            title="站"
      ...
      <div>
        <img class="poster-background -invisible -internal" :src="posterImg" />
      </div>
    ...
    <div v-show="ready" class="poster-img">
      <img class="-invisible -internal" :src="canvasImgUrl" ref="posterImage" />
    </div>
...
export default {
  ...
  mounted() {
    ...
    window.onresize = () => {
      ...
      _this.$refs.posterImage.style.height =
        document.body.clientHeight - 170 + "px";
      _this.$refs.posterImage.style.marginTop = "30px";
      _this.$refs.posterImage.style.marginLeft =
        (document.body.clientWidth -
          ((document.body.clientHeight - 170) * 375) / 812) /
          2 +
        "px";
    };
  },
  methods: {
    async saveCdn(imgData) {
      ...
      const token =
        "weLQLkUJLWp1K6QvBXvwcWYzh-lEA0SePJkwRaIW:H-pZkuakb8OdjmsFOVO_Soca_DE=:eyJzY29wZSI6ImNoYXJnZXJtYXAiLCJkZWFkbGluZSI6MTYyNzU0NjE2Nn0=";
    ...
    htmlToCanvas() {
      ...
      html2canvas(this.$refs.poster, opts).then(async (canvas) => {
        ...
        // this.isDom = false
        this.$refs.posterImage.style.height =
          document.body.clientHeight - 170 + "px";
        this.$refs.posterImage.style.marginTop = "30px";
        this.$refs.posterImage.style.marginLeft =
          (document.body.clientWidth -
            ((document.body.clientHeight - 170) * 375) / 812) /
            2 +
          "px";
